...
export class ContactUsPage {
  ...
  async openForm() {
    ...
    safeAdd(trends.ContactUsPage_openForm_completion_time, vitals.completionTime, tags);
    safeAdd(trends.ContactUsPage_openForm_latency, vitals.latency, tags);
    safeAdd(trends.ContactUsPage_openForm_dom_interactive, vitals.domInteractive, tags);
    safeAdd(trends.ContactUsPage_openForm_network_overhead, vitals.networkOverhead, tags);
    safeAdd(trends.ContactUsPage_openForm_first_response_time, vitals.firstResponseTime, tags);
    safeAdd(trends.ContactUsPage_openForm_content_download, vitals.contentDownload, tags);
    safeAdd(trends.ContactUsPage_openForm_page_ready, vitals.pageReady, tags);
    safeAdd(trends.ContactUsPage_openForm_first_interactive, vitals.firstInteractive, tags);
  ...
  async fillForm() {
    ...
    safeAdd(trends.ContactUsPage_fillForm_completion_time, vitals.completionTime, tags);
    safeAdd(trends.ContactUsPage_fillForm_latency, vitals.latency, tags);
    safeAdd(trends.ContactUsPage_fillForm_dom_interactive, vitals.domInteractive, tags);
    safeAdd(trends.ContactUsPage_fillForm_network_overhead, vitals.networkOverhead, tags);
    safeAdd(trends.ContactUsPage_fillForm_first_response_time, vitals.firstResponseTime, tags);
    safeAdd(trends.ContactUsPage_fillForm_content_download, vitals.contentDownload, tags);
    safeAdd(trends.ContactUsPage_fillForm_page_ready, vitals.pageReady, tags);
    safeAdd(trends.ContactUsPage_fillForm_first_interactive, vitals.firstInteractive, tags);
