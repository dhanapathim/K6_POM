...
export class ChallengesPage {
  ...
  async openChallenges() {
    ...
    safeAdd(
      trends.challengespageOpencompletiontime,
      vitals.completionTime,
      tags
    );
    safeAdd(trends.challengespageOpenlatency, vitals.latency, tags);
    safeAdd(
      trends.challengespageOpendominteractive,
      vitals.domInteractive,
      tags
    );
    safeAdd(
      trends.challengespageOpennetworkoverhead,
      vitals.networkOverhead,
      tags
    );
    safeAdd(
      trends.challengespageOpenfirstresponsetime,
      vitals.firstResponseTime,
      tags
    );
    safeAdd(
      trends.challengespageOpencontentdownload,
      vitals.contentDownload,
      tags
    );
    safeAdd(trends.challengespageOpenready, vitals.pageReady, tags);
    safeAdd(
      trends.challengespageOpenfirstinteractive,
  ...
  async openMiddleManagers() {
    ...
    await this.page.screenshot({
      path: `screenshots/MiddleManagers_${__VU}.png`,
    });
    const vitals = await new PerformanceVitals(this.page).collect();
    ...
    safeAdd(
      trends.middlemanagerspageOpendominteractive,
      vitals.domInteractive,
      tags
    );
    safeAdd(
      trends.middlemanagerspageOpennetworkoverhead,
      vitals.networkOverhead,
      tags
    );
    safeAdd(
      trends.middlemanagerspageOpenfirstresponsetime,
      vitals.firstResponseTime,
      tags
    );
    safeAdd(
      trends.middlemanagerspageOpencontentdownload,
      vitals.contentDownload,
      tags
    );
    safeAdd(trends.middlemanagerspageOpenready, vitals.pageReady, tags);
    safeAdd(
      trends.middlemanagerspageOpenfirstinteractive,
      vitals.firstInteractive,
      tags
    );
  }
